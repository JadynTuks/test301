...
describe("deleteDocument", () => {
    ...
    beforeEach(() => {
      apiClient = new NOSQLClient("http://localhost:3000");
    ...
    test("should successfully delete a document and return response", async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(`${apiClient.baseURL}/document/delete`, {
        method: "POST",
        headers: {
  ...
  describe("createDocument", () => {
    ...
    beforeEach(() => {
        apiClient = new NOSQLClient("http://tonyurl:3000");
    ...
    test("should successfully create a document and return response", async () => {
        ...
        expect(fetch).toHaveBeenCalledWith(`${apiClient.baseURL}/document/create`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${mockData.token}`,
    ...
    describe("readDocument", () => {
        ...
        test("should successfully read a document and return response", async () => {
            ...
            expect(fetch).toHaveBeenCalledWith(`${apiClient.baseURL}/document/read`, {
                method: "POST",
                headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${mockData.token}`,
    ...
    describe("listDocuments", () => {
        ...
        test("should successfully list documents and return response", async () => {
            ...
            expect(fetch).toHaveBeenCalledWith(`${apiClient.baseURL}/document/list`, {
                method: "POST",
                headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${mockData.token}`,
    ...
    describe("updateDocument", () => {
        ...
        test("should successfully update a document and return response", async () => {
            ...
            expect(fetch).toHaveBeenCalledWith(`${apiClient.baseURL}/document/update`, {
                method: "POST",
                headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${mockData.token}`,
    ...
    describe("queryDocuments", () => {
        ...
        test("should successfully query documents and return response", async () => {
            ...
            expect(fetch).toHaveBeenCalledWith(`${apiClient.baseURL}/document/query`, {
                method: "POST",
                headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${mockData.token}`,
